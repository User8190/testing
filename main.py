...
while a == 'y' or a =="Y" :
	print(lG+"")
	sphrase = input("Search Movie / TV Series : ")
	...
	#print(ahrefList[0])
	nx=[]
	print(lW+"Enter the subtitle number(s) of Your choices with commas.")
	xt = input("(If you choiced one Subtitle Not need comma)\n     >>")
	nx = xt.split(",")
	nl=len(nx)
	n = int(nx[nl - 1])
	...
	while nl>0:
		...
		if r3.status_code == 200 :
		    ...
		    file.close()
		    print(lY+"File download success !")
		    print(sv)
		...
		nl = nl -1
		print(lY)
	a = input('Do You Like search Other Film or Tv series [y/n] :')
else:
	...
	if a == 'n' or a == 'N':
		...
		print(lR)
		a = input('Please Enter Only "y" or "n" :')
